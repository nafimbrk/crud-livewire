<div class="container">
        ...
        <form>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    ...
                    @endif
                    <button type="button" class="btn btn-primary" name="submit" wire:click='clear()'>UPDATE</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        <h1>Data Pegawai</h1>
        <div class="pb-3 pt-3">
            <input type="text" name="" id="" class="form-control mb-3 w-25" placeholder="search..." wire:model.live='katakunci'>
        </div>
        ...
        <table class="table table-striped table-sortable">
            ...
            <tbody>
                ...
                <tr>
                    <td><input type="checkbox" wire:key='{{ $value->id }}' name="" id="" value="{{ $value->id }}" wire:model.live='employee_selected_id'></td>
